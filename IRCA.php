...
?>
    ...
    <body>
        <div class="container">
            ...
            <div class="services">
                <div class="service">
                    <img src="img/IRCA/calentador agua.jpeg" alt="Calentadores de Agua">
                    <h2>Instalación y Reparación de Calentadores de Agua</h2>
                ...
                <div class="service">
                    <img src="img/IRCA/deteccion-de-fugas-inicio-01.png" alt="Detección y Reparación de Fugas de Agua">
                    <h2>Detección y Reparación de Fugas de Agua</h2>
                    <p>Confía en nosotros para detectar y reparar cualquier fuga de agua de manera eficiente y oportuna.</p>
                </div>
                <div class="service">
                    <img src="img/IRCA/Casa-Occoa.webp" alt="Instalación y Mantenimiento de Sistemas de Filtración de Agua">
                    <h2>Instalación y Mantenimiento de Sistemas de Filtración de Agua</h2>
                    <p>Te ofrecemos soluciones completas para la instalación y mantenimiento de sistemas de filtración de agua.</p>
                </div>
                <div class="service">
                    <img src="img/IRCA/Proyecto-diseño-e-instalacion-de-riego.jpg" alt="Instalación y Reparación de Sistemas de Riego">
                    <h2>Instalación y Reparación de Sistemas de Riego</h2>
                ...
                <div class="service">
                    <img src="img/IRCA/desatascos-tuberias-badalona.jpg" alt="Desatascos y Limpieza de Tuberías">
                    <h2>Desatascos y Limpieza de Tuberías</h2>
                    <p>Resolvemos problemas de atascos y realizamos limpieza de tuberías de manera rápida y eficiente.</p>
                </div>
            </div>
        </div>
    </body>

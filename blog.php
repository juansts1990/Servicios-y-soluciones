      ...
      <nav class="navbar">
        ...
        <div class="flex-wrapper">
          ...
          <ul class="desktop-nav">
            ...
            <li>
              <a href="contactar.php" class="nav-link">Contacto</a>
            </li>
    ...
    <div class="hero">
      ...
      <div class="container">
        ...
        <div class="left">
          ...
          <div class="btn-group">
            <a href="contactar.php" class="btn btn-primary">Contáctanos</a>
    ...
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <ul class="footer-link">
          ...
          <li>
            <a href="contactar.php" class="footer-link">Contacto</a>
          </li>
